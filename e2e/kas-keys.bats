...
@test "kas-keys: list keys (kas name not registered)" {
  MISSING_KAS_NAME=$(generate_kas_name 12)
...
@test "kas-keys: list keys (kas id not registered)" {
  MISSING_KAS_ID=$(generate_uuid)
