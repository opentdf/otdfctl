...
require (
	...
	github.com/opentdf/platform/protocol/go v0.0.0-20240301211102-04107b3757a9
	github.com/opentdf/platform/sdk v0.0.0-20240305152130-b34c2fe9ad70
...
require (
	...
	github.com/opentdf/backend-go v0.1.16 // indirect
