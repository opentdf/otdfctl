...
type CreateRequestFlags struct {
	Name string `json:"name"` // Name of the custom action (must be unique within Policy)
...
func NewCreateCommand(handler CreateHandler) *cobra.Command {
	...
	// Register flags
	cmd.Flags().String("name", "", "Name of the custom action (must be unique within Policy)")
