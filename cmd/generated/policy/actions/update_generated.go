...
type UpdateRequestFlags struct {
	Id string `json:"id"` // ID of the action to update
	Name string `json:"name"` // Optional updated name of the custom action (must be unique within Policy)
...
func NewUpdateCommand(handler UpdateHandler) *cobra.Command {
	...
	// Register flags
	cmd.Flags().StringP("id", "i", "", "ID of the action to update")
	cmd.MarkFlagRequired("id")
	cmd.Flags().String("name", "", "Optional updated name of the custom action (must be unique within Policy)")
