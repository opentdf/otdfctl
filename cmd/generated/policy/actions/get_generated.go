...
type GetRequestFlags struct {
	Id string `json:"id"` // ID of the action
...
func NewGetCommand(handler GetHandler) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "get",
		Aliases: []string{"g"},
		Short:   "Get a Standard or Custom Action",
	...
	// Register flags
	cmd.Flags().StringP("id", "i", "", "ID of the action")
	cmd.Flags().String("name", "", "Name of the action")
