...
type GetRequestFlags struct {
	Id string `json:"id"` // The ID of the subject condition set to get
}
...
func NewGetCommand(handler GetHandler) *cobra.Command {
	cmd := &cobra.Command{
		Use:     "get",
		Aliases: []string{"g"},
		Short:   "Get a Subject Condition Set",
	...
	// Register flags
	cmd.Flags().StringP("id", "i", "", "The ID of the subject condition set to get")
