...
func init() {
	cmd := man.Docs.GetDoc("policy-subjectMappings")

	createCmd := man.Docs.GetDoc("policy-subjectMappings-create")
	createCmd.Run = runCreateSubjectMappings

	listCmd := man.Docs.GetDoc("policy-subjectMappings-list")
	listCmd.Run = runListSubjectMappings

	updateCmd := man.Docs.GetDoc("policy-subjectMappings-update")
	updateCmd.Run = runUpdateSubjectMappings

	deleteCmd := man.Docs.GetDoc("policy-subjectMappings-delete")
	deleteCmd.Run = runDeleteSubjectMappings

	getCmd := man.Docs.GetDoc("policy-subjectMappings-get")
